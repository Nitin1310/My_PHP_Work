...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="register.php" class="w3-bar-item w3-button w3-padding-large">Send Money</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  ...
  <div class="w3-container" id="contact" style="margin-top:75px">
    ...
    <form action="pass.php" target="_blank" method="post">
      <div class="w3-section">
        <label>SET PASSCODE</label>
        <input class="w3-input w3-border" type="text" name="pass" placeholder="SIX DIGIT" required>
      </div>
